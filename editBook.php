...
<?php include "editBookCode.php" ; ?>
    ...
    <button type="submit" class="signupbtn"name="Update"> Update</button><button class="cancelbtn" type="button"><a href="viewBooks.php">  Back to view Books </a></button>
